...
var Weatherr = function () {
    var _a = (0, react_1.useState)(), locationData = _a[0], setLocationData = _a[1];
    var _b = (0, react_1.useState)(), weatherData = _b[0], setWeatherData = _b[1];
    ...
    return (<div>
      <span>zz</span>
      <span>{locationData === null || locationData === void 0 ? void 0 : locationData.localizedName}</span>
      <span>{weatherData === null || weatherData === void 0 ? void 0 : weatherData.temperature}</span>
      <span>{weatherData === null || weatherData === void 0 ? void 0 : weatherData.weatherText}</span>
    </div>);
};
